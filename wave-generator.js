 ...
 for (index = 0; index < 300; index++)
{
    ...
    SINEWAVE_TABLE[index] = 65 - (Math.trunc(  Math.sin((  (((distance * 180/198) % 180) * Math.PI)  /180)) * 128  ));

    if (SINEWAVE_TABLE[index] < prev)
        direction = 0;
    else if (SINEWAVE_TABLE[index] > prev)
        direction = 1;
